...
const tests2PruebasVarias = async ()=>{
    ...
    await productManager.updateProduct({id: 7, title: "ultimo elemento", description:"anteriormente era el 4", price:"242423.564", thumbnail:"sin foto",code:"aa234",stock:"0"}) 
